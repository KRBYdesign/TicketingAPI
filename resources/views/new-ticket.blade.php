<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="grid grid-cols-6 px-12 gap-8 h-[800px] overflow-y-hidden">
            <form class="px-8 py-12 bg-neutral-50 dark:bg-neutral-800 col-start-2 col-span-4 position-relative overflow-y-auto" action="{{ url('/tickets/create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="position-absolute mb-6 position-relative">
                        ...
                        <div class="relative">
                            <!-- input element-->
                            <input id="type_input" type="text" class="z-10 relative bbg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-neutral-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly placeholder="Please Make A Selection" />

                            <!-- drop down icon -->
                            <div class="absolute top-0 right-0 z-20 rounded-r-md border-l-[1px] bbg-gray-50 border focus:ring-blue-500 focus:border-blue-500 h-full w-12 p-2.5 dark:bg-neutral-600 dark:border-gray-600 flex items-center dark:hover:ring-[1px] dark:hover:ring-blue-500" id="expand_type_selection" aria-expanded="false">
                            ...
                            <!-- drop down menu -->
                            <div id="type_dropdown" class="z-0 absolute top-0 left-0 w-full h-0 bg-neutral-700 overflow-y-hidden pt-10 border rounded-lg border-neutral-500">
                                <p class="option text-right px-4 py-2 text-neutral-300 hover:bg-neutral-500">Design / Artwork</p>
                                <p class="option text-right px-4 py-2 text-neutral-300 hover:bg-neutral-500">Website Update / Creation</p>
                                <p class="option text-right px-4 py-2 text-neutral-300 hover:bg-neutral-500">Tech Issues</p>
                                <p class="option text-right px-4 py-2 text-neutral-300 hover:bg-neutral-500">Software Assistance / Install</p>
                                <p class="option text-right px-4 py-2 text-neutral-300 hover:bg-neutral-500">Other</p>
                            </div>
                        </div>

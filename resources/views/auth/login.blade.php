<x-guest-layout>
    ...
    <p class="text-2xl text-neutral-300 text-center my-4">Login</p>
    ...
    <p class="text-sm text-neutral-600 dark:text-neutral-400 text-center mt-4">Need an account?<br>
        <a class="text-sm text-neutral-600 dark:text-neutral-400 text-center underline hover:text-neutral-900 dark:hover:text-neutral-100" href="{{ route('register') }}">Register Here</a>
    </p>
</x-guest-layout>
